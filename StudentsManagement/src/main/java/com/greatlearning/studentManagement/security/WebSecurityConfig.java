...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	// Dao authentication provider verifies with the database and authenticates the user
	// It sends back the authenticated User Details object to authentication manager
	@Bean
	...
	// Authentication Manager talks to authentication provider like dao authentication provider in our case
	@Override
